<?php /* Smarty version Smarty-3.1.14, created on 2017-10-26 18:17:11
         compiled from "F:\WWW\shopx\manage\templates\default\point_size.html" */ ?>
<?php /*%%SmartyHeaderCode:3042059f1b6270eef92-25784474%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1592b1443acf902aaa9516552dea13daa6ee9fab' => 
    array (
      0 => 'F:\\WWW\\shopx\\manage\\templates\\default\\point_size.html',
      1 => 1451523882,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3042059f1b6270eef92-25784474',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59f1b62719ec46_24502589',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59f1b62719ec46_24502589')) {function content_59f1b62719ec46_24502589($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
" />  
	...
	<div class="pro_nr" id="header">
		...
		<div class="pro_xx">
			<div class="tl">
				<span class="pro_tbl1">
					<a href="javascript:DialogIframe('point_size.php?act=add','<?php echo $_smarty_tpl->tpl_vars['lang']->value['point_size_add'];?>
','80%','95%','','','','dosubmit');">
					<img src="templates/default/images/tbl1.jpg" align="left" />&nbsp;<?php echo $_smarty_tpl->tpl_vars['lang']->value['point_size_add'];?>
</a>
				</span>
				<span class="pro_tbl1">
					<a href="javascript:UpOrderID('point_size.php');">
			...
			<div class="tr">
				 <a href="javascript:Upselect('point_size.php','list');" class="tr"><img src="templates/default/images/pro_7.jpg" /></a>
...
"  />
					...
					<td width="20%" align="left" valign="middle" class="pro_tbr pro_l5">
						...
						&nbsp;<a href="javascript:DialogIframe('point_size.php?act=add&parentid=<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
','<?php echo $_smarty_tpl->tpl_vars['lang']->value['point_size_add'];?>
','80%','95%','','','','dosubmit');"><?php echo $_smarty_tpl->tpl_vars['lang']->value['action_add'];?>
</a>
						&nbsp;<a href="point_size.php?act=list&parentid=<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['lang']->value['action_manage'];?>
</a>
						&nbsp;<a href="javascript:DialogIframe('point_size.php?act=edit&id=<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
','<?php echo $_smarty_tpl->tpl_vars['lang']->value['point_size_edit'];?>
','80%','95%','','','','dosubmit');"><?php echo $_smarty_tpl->tpl_vars['lang']->value['action_edit'];?>
						...
						<?php }else{ ?>
						&nbsp;<a href="javascript:;" onclick="return ConfDel('point_size.php?act=subdel&id=<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
