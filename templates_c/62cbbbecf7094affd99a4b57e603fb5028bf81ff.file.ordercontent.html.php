<?php /* Smarty version Smarty-3.1.14, created on 2017-10-26 17:19:37
         compiled from "F:\WWW\shopx\templates\default\ordercontent.html" */ ?>
<?php /*%%SmartyHeaderCode:1332659f1a8a91bbd72-96216605%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '62cbbbecf7094affd99a4b57e603fb5028bf81ff' => 
    array (
      0 => 'F:\\WWW\\shopx\\templates\\default\\ordercontent.html',
      1 => 1469787006,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1332659f1a8a91bbd72-96216605',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59f1a8a9359ed0_65347721',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59f1a8a9359ed0_65347721')) {function content_59f1a8a9359ed0_65347721($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div class="body">
<div class="bodys">
        <div class="help"><span class="help_tops"><strong class="lsize">会员中心</strong> ><a href="#"> 订单中心</a> > 订单：<?php echo $_smarty_tpl->tpl_vars['order']->value['orderlistnum'];?>
</span></span></div>
        <div class="ddxq_top">
  ...
  状态：<span class="lcolor"> 
            		 <?php if ($_smarty_tpl->tpl_vars['payment_info']->value['is_cod']==1){?>
            货到付款:<?php if ($_smarty_tpl->tpl_vars['order']->value['checkinfo']==0){?>
                    等待付款
...
"/> 
                ...
                <div id="info" style="display:none;">
                	<div class="ddxx_list">
                        <ul>
                            <li>支付及配送方式<br />
                                支付方式：<?php if ($_smarty_tpl->tpl_vars['payment_info']->value['is_online']==1){?>在线支付<?php }elseif($_smarty_tpl->tpl_vars['payment_info']->value['is_cod']==1){?>货到付款<?php }else{ ?>其它<?php }?><br />
...
<br />
                        送货日期 ：无</li>
                    <li>发票信息<br />
                        发票类型：<?php if ($_smarty_tpl->tpl_vars['order']->value['InvoiceType']==1){?>普通发票<?php }else{ ?>其他<?php }?><br />
                        发票抬头：无<br />
                        发票内容：无</li>
                </ul>
            </div>
