...
define('LCSHOP_INC'		, str_replace('include/config.php', '', str_replace('\\', '/', __FILE__)));//路径
define('ADMIN_INC'		, preg_replace("/[\/\\\\]{1,}/", '/', dirname(__FILE__)));//转义字符
define('LCSHOP_DATA'	, LCSHOP_INC . 'data/');//配置文件
define('LCSHOP_TEMP'	, LCSHOP_INC . 'templates/');//模版
...
include_once(LCSHOP_DATA .'../x.php');	//防注入
...
$smarty->assign('cfg_checkinfo'  ,$cfg_checkinfo);//未付款订单失效时间
...
$smarty->assign('template_dir'      ,"templates/default/");		//网站名称	
if (@$from == '')
{
