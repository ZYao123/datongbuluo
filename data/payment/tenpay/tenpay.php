...
/* 获取提交的商品名称 */
$product_name = $pay_config["product_name"];
/* 获取提交的商品价格 */
$order_price = $pay_config["order_price"];
/* 获取提交的备注信息 */
$remarkexplain = $pay_config["remarkexplain"];
/* 支付方式 */
$trade_mode=$pay_config["trade_mode"];
...
$html_text = '<a href="'.$reqUrl.'">财付通支付</a>
			<form action="'.$reqHandler->getGateUrl().'" method="post" id="Pay" name="Pay">';
...
<input type="submit" value="财付通支付"></form>';
?>
