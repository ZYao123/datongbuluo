...
require_once "data/payment/wxpay/lib/WxPay.Api.php";
require_once "data/payment/wxpay/exp/WxPay.NativePay.php";
require_once 'data/payment/wxpay/exp/log.php';
...
$SERVER_URL = "http://".$_SERVER['SERVER_NAME']."/shopx/data/payment/wxpay/exp/native_notify.php";
...
$html_text .= "<div style=\"margin-bottom:15px;font-size:14px;\">正在使用微信扫码交易<br><b style='font-size:16px; margin-right:60px;'>".$pay_config['product_name']."</b>收款方：".$cfg_webname."</div><div style=\"text-align:center;border-top: solid 3px #ccc;border-bottom: solid 3px #ccc; margin-bottom:50px; padding-top:80px; padding-bottom:100px;\"><span style='line-height:35px; font-size:14px'>扫一扫付款（元）</span><br><span style='font-size:25px; font-weight:bold; color:#ff6600'>".$pay_config['order_price']."</span><br><br><div style=\"border: solid 1px #ccc; width:222px; margin:0 auto;	box-shadow: 2px 2px #ccc;\"><img alt=\"微信扫码支付\" src=\"data/payment/wxpay/exp/phpqrcode/qrcode.php?data=".urlencode($url2)."\" width='222' id='qr'/><div id='bottom'><img alt=\"微信扫码支付\" src=\"data/payment/wxpay/exp/images/3.jpg\" style=\"margin-bottom:8px;\"></div><div id='sum'></div></div></div>";
		...
		$str.="<a class=\"a_bigImg\"><img src=\"data/payment/wxpay/exp/images/1.jpg\" width=\"204\" height=\"182\" alt=\"\" /></a>\n";
		$str.="<a class=\"a_bigImg\"><img src=\"data/payment/wxpay/exp/images/2.jpg\" width=\"204\" height=\"182\" alt=\"\" /></a>\n";
		$str.="<ul class=\"ul_change_a2\">\n";
		$str.="<li><span>&nbsp;</span></li>\n";
		$str.="<li><span>&nbsp;</span></li>\n";
		$str.="</ul>\n";
		$str.="</div>\n";
		$str.="<script type=\"text/javascript\" src=\"data/payment/wxpay/exp/images/jquery.soChange-min.js\"></script>\n";
		$str.="<script>\n";
...
$str.="}\n";
$str.="$('#sum').html(sum);\n";
$str.="$.get('data/payment/wxpay/exp/native_state.php?id=".$pay_config['order_no']."',function(data){\n";
$str.="v=eval(\"(\"+data+\")\");\n";
...
$str.="if(v.url==''){\n";
$str.="$(\"#qr\").attr('src','data/payment/wxpay/exp/images/done.png');\n";
