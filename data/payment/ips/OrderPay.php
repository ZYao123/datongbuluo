...
<html>
  ...
  <body bgcolor="#FFFFFF">
    <form action="redirect.php" METHOD="POST" name="frm1" target="_blank">	
      <table width="450px" border="1" cellspacing="0" cellpadding="3" bordercolordark="#FFFFFF" bordercolorlight="#333333" bgcolor="#F0F0FF" align="center">
        ...
        <tr>
          <td>订单号</td>
          <td>
            <input type="text" name="Billno" size="24" value="<?php echo $orderlistnum; ?>" />
          </td>
        </tr>
        <tr>
          <td>金&nbsp;&nbsp;额</td>
          <td>
            <input type="text" name="Amount" size="18" value="<?php echo $orderamount; ?>" /><!--保留两位小数-->
          </td>
        </tr>
        <tr>
          <td>显示金额</td>
          <td>
            <input type="text" name="DispAmount" size="18" value="<?php echo $orderamount; ?>" />
          </td>
        </tr>
        <tr>
          <td>日&nbsp;&nbsp;期</td>
