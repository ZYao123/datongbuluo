...
function colorpicker(showid,fun,id2)
{
	...
	colorTable='<style>a.close-own{background: url(plugin/colorpicker/cross.png) no-repeat left 3px;display:block;width:16px;height:16px;position:absolute;outline:none;right:7px;top:8px;text-indent:200px; overflow: hidden}a.close-own:hover{background-position: left -46px}.color_nav tr td{padding:0px;border:0px}</style>'
	           +'<div style="position:relative;width:317px; height:220px;"><a href="javascript:;" onclick="closeBox(\''+showid+'\');" class="close-own">X</a><table width=100% border="0" cellspacing="0" cellpadding="0" style="border:1px #000 solid #000;border-bottom:none;border-collapse:collapse">'
			   +'<tr height=30><td colspan="21" bgcolor="#eeeeee">'
			   +'<table cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse" class="color_nav">'
			   ...
			   +'<td width="3"><td><input type="text" name="HexColor" size="7" id="input_colorId" style="border:inset 1px;font-family:Arial;" value="#000000"></td><td>&nbsp;&nbsp;<a href="javascript:;" onclick="enter_title(\''+showid+'\',\''+fun+'\',\''+id2+'\');" title="确认自定义颜色">[确定]</a>&nbsp;<a href="javascript:;" onclick="clear_title(\''+fun+'\',\''+id2+'\');" title="清除设定的标题颜色">[清除]</a></td></tr></table></td></table>'
			   +'<table border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="000000">'
			   +colorTable+'</table></div>';
	$('#'+showid).css({'position':'absolute','z-index':'999'});
...
//输入自定义颜色
function enter_title(showid,fun,id2)
{
